...
while(formattedGuess !== correctAnswer && numberOfTries < numberOfChances  ){
  ...
  console.log(`==>SORRY ${capitalizedUserName}: You guessed the number ${formattedGuess}, it is incorrect, try again. You have ${numberOfChances - numberOfTries} ${numberOfChances - numberOfTries > 1 ? "tries" : "try" } left`)
